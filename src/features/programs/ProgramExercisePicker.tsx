                        ...
                        {session.exercises.map((exercise, index) => (
                          ...
                          >
                            <input
                              ...
                              className="mt-1 w-5 h-5 rounded border-white/20 bg-bg-secondary checked:bg-purple-600 focus:ring-purple-600"
                            />
        ...
        <div className="sticky bottom-0 z-10 bg-bg-secondary p-4 md:p-6 border-t border-border flex items-center justify-between">
          ...
          {step === 'sessions' && selectedExercises.length > 0 && (
            <button
              ...
              className="px-4 py-2 md:px-6 bg-purple-600 text-text-primary rounded-lg hover:bg-purple-700 transition-colors flex items-center gap-2"
            >
