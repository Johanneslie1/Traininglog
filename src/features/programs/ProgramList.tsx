...
const ProgramListContent: React.FC<{ onSelect?: (id: string) => void }> = ({ onSelect }) => {
  ...
  const handleDeleteProgram = async (programId: string, programName: string, event: React.MouseEvent) => {
    ...
    if (isDefaultProgram(programId)) {
      setError('Cannot delete built-in programs');
      return;
    }
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {programs.map((program: Program) => {
            ...
            >
              ...
              {/* Built-in badge */}
              {isBuiltIn && (
                <div className="absolute top-3 left-3 px-2.5 py-1 bg-gradient-to-r from-blue-600/90 to-purple-600/90 text-white text-xs font-semibold rounded-lg flex items-center gap-1.5 z-20">
              ...
              {/* Delete button - only show for user programs */}
              {!isBuiltIn && (
                <button
