...
export const legExercises: ExerciseTemplate[] = [
  ...
  },
  {
    ...
    description: 'A loaded standing calf raise emphasizing gastrocnemius development.',
    type: 'strength',
    category: 'isolation',
    primaryMuscles: ['calves'],
    secondaryMuscles: ['core'],
    equipment: ['barbell', 'rack'],
    instructions: ['Unrack barbell on upper back', 'Rise onto toes as high as possible', 'Lower heels with control to a stretch'],
    metrics: defaultMetrics,
    defaultUnit: 'kg'
  },
  {
    name: '45-Degree Leg Press Calf Raise',
    description: 'A leg press calf variation emphasizing controlled plantarflexion under load.',
    type: 'strength',
    category: 'isolation',
    primaryMuscles: ['calves'],
    secondaryMuscles: [],
    equipment: ['machine'],
    instructions: ['Set feet on lower edge of platform', 'Press through forefoot to raise heels', 'Lower heels slowly to full stretch'],
    metrics: defaultMetrics,
    defaultUnit: 'kg'
  },
  {
    name: 'Seated Barbell Calf Raise',
    description: 'A seated calf raise variation that targets the soleus with external load.',
    type: 'strength',
    category: 'isolation',
    primaryMuscles: ['calves'],
    secondaryMuscles: [],
    equipment: ['barbell', 'bench'],
    instructions: ['Sit with knees bent and barbell across thighs', 'Raise heels by pressing through forefoot', 'Lower under control'],
    metrics: defaultMetrics,
    defaultUnit: 'kg'
  },
  {
    name: 'Standing Barbell Calf Raise',
    description: 'A standing barbell calf raise emphasizing gastrocnemius development.',
    type: 'strength',
    category: 'isolation',
    primaryMuscles: ['calves'],
    secondaryMuscles: ['core'],
    equipment: ['barbell', 'rack'],
    instructions: ['Place barbell on upper back', 'Rise onto toes as high as possible', 'Lower with controlled stretch'],
    metrics: defaultMetrics,
    defaultUnit: 'kg'
  },
  {
    name: 'Smith Machine Calf Raise',
    description: 'A guided standing calf raise using a Smith machine for stability.',
    type: 'strength',
    category: 'isolation',
    primaryMuscles: ['calves'],
    secondaryMuscles: [],
    equipment: ['machine'],
    instructions: ['Set bar on upper back in Smith machine', 'Raise heels fully', 'Lower slowly below platform level'],
    metrics: defaultMetrics,
    defaultUnit: 'kg'
  },
  {
    name: 'Seated Calf Raise',
    description: 'A seated calf movement with bent-knee emphasis on the soleus.',
    type: 'strength',
    category: 'isolation',
    primaryMuscles: ['calves'],
    secondaryMuscles: [],
    equipment: ['machine'],
    instructions: ['Set thighs under pad with feet on platform', 'Raise heels as high as possible', 'Lower into stretch with control'],
    metrics: defaultMetrics,
    defaultUnit: 'kg'
  },
  {
    name: 'Single-Leg Calf Raise',
    description: 'A unilateral calf raise improving ankle strength and balance.',
    type: 'strength',
    category: 'isolation',
    primaryMuscles: ['calves'],
    secondaryMuscles: [],
    equipment: ['bodyweight'],
    instructions: ['Stand on one foot with support nearby', 'Raise heel as high as possible', 'Lower slowly and repeat before switching sides'],
    metrics: { trackReps: true, trackRPE: true },
    defaultUnit: 'reps'
  },
  {
    name: 'Donkey Calf Raise',
    description: 'A hip-hinged calf raise variation emphasizing stretch and peak contraction.',
    type: 'strength',
    category: 'isolation',
    primaryMuscles: ['calves'],
    secondaryMuscles: [],
    equipment: ['bodyweight', 'machine'],
    instructions: ['Hinge at hips with forefoot elevated', 'Raise heels by pressing through forefoot', 'Lower slowly into stretch'],
    metrics: defaultMetrics,
    defaultUnit: 'kg'
  },
  {
    name: 'Slant Board Calf Raise',
    description: 'A calf raise variation performed on an incline board for increased range.',
    type: 'strength',
    category: 'isolation',
    primaryMuscles: ['calves'],
    secondaryMuscles: [],
    equipment: ['bodyweight'],
    instructions: ['Stand on slant board with forefoot supported', 'Raise heels into plantarflexion', 'Lower slowly into deep stretch'],
    metrics: defaultMetrics,
    defaultUnit: 'kg'
  },
  {
    name: 'Bent-Knee Calf Raise',
    description: 'A calf raise with knee flexion to bias the soleus muscle.',
    type: 'strength',
    category: 'isolation',
    primaryMuscles: ['calves'],
    secondaryMuscles: [],
    equipment: ['bodyweight', 'dumbbells'],
    instructions: ['Assume slight squat with knees bent', 'Raise heels while keeping knees flexed', 'Lower slowly without straightening knees'],
    metrics: defaultMetrics,
    defaultUnit: 'kg'
  },
  {
    name: 'Heel Walks',
    description: 'A dorsiflexion-focused walk strengthening the anterior lower leg.',
    type: 'strength',
    category: 'isolation',
    primaryMuscles: ['calves'],
    secondaryMuscles: [],
    equipment: ['bodyweight'],
    instructions: ['Lift toes and keep weight on heels', 'Walk forward with controlled steps', 'Maintain toes elevated throughout set'],
    metrics: { trackTime: true, trackDistance: true, trackRPE: true },
    defaultUnit: 'time'
  },
  {
    name: 'Tibialis Raise',
    description: 'A dorsiflexion-focused movement strengthening the front of the lower leg.',
    type: 'strength',
    category: 'isolation',
    primaryMuscles: ['calves'],
    secondaryMuscles: [],
    equipment: ['bodyweight'],
    instructions: ['Stand with back supported by a wall', 'Lift forefoot and toes upward', 'Lower slowly to start position'],
    metrics: { trackReps: true, trackRPE: true },
    defaultUnit: 'reps'
  },
  {
    name: 'Tibialis Curl Kettlebell',
    description: 'A weighted tibialis-focused curl movement using a kettlebell.',
    type: 'strength',
    category: 'isolation',
    primaryMuscles: ['calves'],
    secondaryMuscles: [],
    equipment: ['kettlebell'],
    instructions: ['Sit on bench with heel planted', 'Hook kettlebell to forefoot safely', 'Lift toes toward shin then lower with control'],
    metrics: defaultMetrics,
    defaultUnit: 'kg'
  },
  {
    name: 'Toe Walks',
    description: 'A calf-endurance walk performed on the balls of the feet.',
    type: 'strength',
    category: 'isolation',
    primaryMuscles: ['calves'],
    secondaryMuscles: [],
    equipment: ['bodyweight'],
    instructions: ['Rise onto toes and keep heels elevated', 'Walk forward in short controlled steps', 'Maintain posture and continue for set time or distance'],
    metrics: { trackTime: true, trackDistance: true, trackRPE: true },
    defaultUnit: 'time'
  },
  {
