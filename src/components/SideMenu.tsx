      ...
      <div className="fixed left-0 top-0 bottom-0 w-72 bg-bg-secondary z-50 shadow-xl flex flex-col translate-x-0 transition-transform duration-300 ease-in-out">
        ...
        <div className="flex-1 overflow-y-auto p-2 space-y-4">
          ...
          <div className="space-y-1">
            ...
            <button onClick={onNavigatePrograms} className="w-full flex items-center gap-3 px-4 py-3 text-text-primary hover:bg-bg-tertiary rounded-lg transition-colors">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button onClick={onNavigateExercises} className="w-full flex items-center gap-3 px-4 py-3 text-text-primary hover:bg-bg-tertiary rounded-lg transition-colors">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
