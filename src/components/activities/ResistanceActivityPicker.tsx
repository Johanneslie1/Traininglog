    ...
    <div className="fixed inset-0 bg-bg-primary/90 flex items-center justify-center p-4 z-50">
      <div className="bg-bg-secondary rounded-xl w-full max-w-5xl max-h-[90vh] flex flex-col overflow-hidden">
        <div className="absolute top-4 left-4 flex gap-2">
          <button onClick={onBack} className="px-3 py-1 rounded-md bg-bg-tertiary text-text-secondary hover:text-text-primary hover:bg-bg-quaternary text-sm">← Back</button>
        </div>
