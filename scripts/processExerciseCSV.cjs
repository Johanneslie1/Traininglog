...
// Category mapping helper function (similar to the one in importExercisesToFirebase.cjs)
...
// Type mapping helper function (similar to the one in importExercisesToFirebase.cjs)
