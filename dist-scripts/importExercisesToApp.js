...
function guessCategory(bodyPart) {
    if (!bodyPart)
        return 'compound';
    ...
    if (b.includes('back'))
        return 'compound';
    if (b.includes('leg') || b.includes('quad') || b.includes('hamstring') || b.includes('glute') || b.includes('calf'))
        return 'compound';
    if (b.includes('shoulder'))
        return 'compound';
    if (b.includes('arm') || b.includes('bicep') || b.includes('tricep') || b.includes('forearm'))
        return 'isolation';
    return 'compound';
}
function guessDefaultUnit(equipment) {
    if (!equipment)
        return 'reps';
    const e = equipment.toLowerCase();
    if (e.includes('barbell') || e.includes('dumbbell') || e.includes('machine') || e.includes('bands'))
        return 'kg';
    if (e.includes('bodyweight'))
        return 'reps';
    return 'reps';
}
